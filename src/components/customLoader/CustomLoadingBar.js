...
class CustomLoadingBar extends Component {
  static propTypes = {
    className: string,
    loading: number,
    maxProgress: number,
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    if (CustomLoadingBar.shouldStart(nextProps, prevState)) {
      return { status: 'starting' }
    }

    if (CustomLoadingBar.shouldStop(nextProps, prevState)) {
...
polyfill(CustomLoadingBar)
const ConnectedLoadingBar = connect(mapStateToProps)(CustomLoadingBar)
